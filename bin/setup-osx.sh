...
if brew list ack 1>/dev/null; then
  fancy_echo "ack already installed"
else
  fancy_echo "ack..."
  successfully brew install ack
fi

if brew list cowsay 1>/dev/null; then
  fancy_echo "cowsay already installed"
else
  fancy_echo "cowsay..."
  successfully brew install cowsay
fi

if brew list s3cmd 1>/dev/null; then
  fancy_echo "s3cmd already installed"
else
  fancy_echo "s3cmd..."
  successfully brew install s3cmd
  fancy_echo "run s3cmd --help to install AWS keys"
fi
